        ...
        10538: function(t, e, r) {
            ...
            var h = "undefined" == typeof window || void 0 === window.document || void 0 === window.document.createElement ? a : function(t, e) {
                var r = e(),
                    ...
                    a = s[1];
                return o(function() {
                    i.value = r, i.getSnapshot = e, c(i) && a({
                        inst: i
                    })
                }, [t, r, e]), u(function() {
                    return c(i) && a({
        ...
        89335: function(t, e, r) {
            ...
            class l extends u.l {
                ...
                setOptions(t, e) {
                    ...
                    n && h(this.currentQuery, i, this.options, r) && this.executeFetch(), this.updateResult(e), n && (this.currentQuery !== i || this.options.enabled !== r.enabled || this.options.staleTime !== r.staleTime) && this.updateStaleTimeout();
                    let u = this.computeRefetchInterval();
                    n && (this.currentQuery !== i || this.options.enabled !== r.enabled || u !== this.currentRefetchInterval) && this.updateRefetchInterval(u)
                }
                ...
                updateRefetchInterval(t) {
                    this.clearRefetchInterval(), this.currentRefetchInterval = t, !s.sk && !1 !== this.options.enabled && (0, s.PN)(this.currentRefetchInterval) && 0 !== this.currentRefetchInterval && (this.refetchIntervalId = setInterval(() => {
                        (this.options.refetchIntervalInBackground || n.j.isFocused()) && this.executeFetch()
                ...
                createResult(t, e) {
                    ...
                    if (e._optimisticResults) {
                        let I = this.hasListeners(),
                            C = !I && c(t, e),
                            O = I && h(t, r, e, i);
                        (C || O) && (m = (0, o.Kw)(t.options.networkMode) ? "fetching" : "paused", v || (S = "loading")), "isRestoring" === e._optimisticResults && (m = "idle")
                    }
                    if (e.keepPreviousData && !y.dataUpdatedAt && null != f && f.isSuccess && "error" !== S) g = f.data, v = f.dataUpdatedAt, S = f.status, E = !0;
                    else if (e.select && void 0 !== y.data) {
                        if (n && y.data === (null == u ? void 0 : u.data) && e.select === this.selectFn) g = this.selectResult;
                        else try {
                            this.selectFn = e.select, g = e.select(y.data), g = (0, s.oE)(null == n ? void 0 : n.data, g, e), this.selectResult = g, this.selectError = null
                        } catch (T) {
                            this.selectError = T
                        }
                    } else g = y.data;
                    if (void 0 !== e.placeholderData && void 0 === g && "loading" === S) {
                        let w;
                        if (null != n && n.isPlaceholderData && e.placeholderData === (null == l ? void 0 : l.placeholderData)) w = n.data;
                        ...
                        void 0 !== w && (S = "success", g = (0, s.oE)(null == n ? void 0 : n.data, w, e), Q = !0)
                    }
                    this.selectError && (R = this.selectError, g = this.selectResult, b = Date.now(), S = "error");
                    let U = "fetching" === m,
                        k = "loading" === S,
                        x = "error" === S,
                        P = {
                ...
                notify(t) {
                    i.V.batch(() => {
                        var e, r, s, i, n, u, o, l;
                        t.onSuccess ? (null == (e = (r = this.options).onSuccess) || e.call(r, this.currentResult.data), null == (s = (i = this.options).onSettled) || s.call(i, this.currentResult.data, null)) : t.onError && (null == (n = (u = this.options).onError) || n.call(u, this.currentResult.error), null == (o = (l = this.options).onSettled) || o.call(l, void 0, this.currentResult.error)), t.listeners && this.listeners.forEach(t => {
        ...
        56137: function(t, e, r) {
            ...
            let p = (t, e) => {
                ...
                y = ({
                    ...
                    useErrorBoundary: r,
                    query: s
                }) => t.isError && !e.isReset() && !t.isFetching && (0, d.L)(r, [t.error, s]),
                v = t => {
                ...
                m = (t, e, r) => e.fetchOptimistic(t).then(({
                    data: e
                }) => {
            ...
            function S(t, e) {
                ...
                a._optimisticResults = u ? "isRestoring" : "optimistic", a.onError && (a.onError = n.V.batchCalls(a.onError)), a.onSuccess && (a.onSuccess = n.V.batchCalls(a.onSuccess)), a.onSettled && (a.onSettled = n.V.batchCalls(a.onSettled)), v(a), p(a, o), f(o);
                let [d] = s.useState(() => new e(r, a)), R = d.getOptimisticResult(a);
                if ((0, i.$)(s.useCallback(t => u ? () => void 0 : d.subscribe(n.V.batchCalls(t)), [d, u]), () => d.getCurrentResult(), () => d.getCurrentResult()), s.useEffect(() => {
                        d.setOptions(a, {
                            listeners: !1
                        })
                    }, [a, d]), b(a, R, u)) throw m(a, d, o);
                if (y({
                        result: R,
