        ...
        60814: function(e, t, n) {
            ...
            var d = n(34388),
                ...
                g = function(e) {
                    ...
                    function n(e, r, s, a) {
                        var i;
                        return (0, o.Z)(this, n), (i = t.call(this, e)).name = "UserError", i.userMessage = e, i.status = r || 400, i.code = s || null, i.type = a || null, i
                    }
                    return n
                }((0, p.Z)(Error)),
                m = function(e) {
                    ...
                    function n() {
                        var e, r, s = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "An error occurred. If this issue persists please contact us through our help center at help.openai.com.",
                            a = arguments.length > 1 ? arguments[1] : void 0;
                        return (0, o.Z)(this, n), (e = t.call(this, (r = s, r && (r.startsWith("Rate limit reached for") || r.startsWith("End-user exceeded rate-limit")) ? "We're sorry, but we limit the number of requests one user can make in a certain timeframe. Please hang tight and try again in a little while." : r))).name = "FatalError", e.type = a || null, e
                    }
                    return n
                }((0, p.Z)(Error)),
                y = n(24638),
                ...
                T = function() {
                    ...
                    return e.setAccessToken = function(e) {
                        ...
                        return (0, r.Z)(function() {
                            ...
                            return (0, c.__generator)(this, function(c) {
                                switch (c.label) {
                                    ...
                                    case 3:
                                        return h = (null == (u = c.sent()) ? void 0 : u.detail) || (null == u ? void 0 : u.error), [3, 5];
                                    case 4:
                                        return d = c.sent(), console.error("Failed to parse error response", d), [3, 5];
                                    case 5:
                                        if (console.error("API error", e, h), !((null == h ? void 0 : h.code) === "expired_session_key" || (null == h ? void 0 : h.code) === "token_expired")) return [3, 11];
                                        c.label = 6;
                                    case 6:
                                        if (c.trys.push([6, 9, , 10]), n.isRetry) return [3, 8];
                                        return [4, o.refreshApiKey()];
                                    case 7:
                                        return c.sent(), [2, o.fetch(e, r, (0, i.Z)((0, a.Z)({}, n), {
                                            isRetry: !0
                                        }))];
                                    case 8:
                                        return [3, 10];
                                    case 9:
                                        return l = c.sent(), console.error("Failed to refresh expired access token: ".concat(l)), [3, 10];
                                    case 10:
                                        console.error("Refresh access token failed when retrieving", e, h), window._oaiHandleSessionExpired("fetch", JSON.stringify(h)), c.label = 11;
                                    case 11:
                                        if (null == h ? void 0 : h.type) throw new g((null == h ? void 0 : h.message) || h, s.status, null == h ? void 0 : h.code, null == h ? void 0 : h.type);
                                        throw new m;
                                    case 12:
                        ...
                        return this.fetch("".concat(v, "/conversation/gen_title/").concat(e), {
                            method: "POST",
                            headers: (0, a.Z)({
                                "Content-Type": "application/json"
                            }, this.getAuthHeader()),
                        ...
                        return (0, r.Z)(function() {
                            ...
                            return (0, c.__generator)(this, function(l) {
                                return i = new AbortController, u = {
                                    ...
                                    model: e.model
                                }, (0, h.L)("".concat("https://chat.openai.com/backend-api", "/conversation"), {
                                    method: "POST",
                                    credentials: "include",
                                    headers: (0, a.Z)({
                                        "Content-Type": "application/json",
                                                ...
                                                switch (o.label) {
                                                    ...
                                                    case 1:
                                                        if (n = o.sent(), console.error(n), r = (null == n ? void 0 : n.error) || (null == n ? void 0 : n.detail)) {
                                                            if (e.status >= 500) throw new m((null == r ? void 0 : r.message) || r);
                                                            throw ((null == r ? void 0 : r.code) === "expired_session_key" || (null == r ? void 0 : r.code) === "invalid_api_key" || (null == r ? void 0 : r.code) === "token_expired") && window._oaiHandleSessionExpired("stream", JSON.stringify(r)), new g((null == r ? void 0 : r.message) || r, e.status, null == r ? void 0 : r.code, null == r ? void 0 : r.type)
                                                        }
                                                        o.label = 2;
                                                    case 2:
                                                        throw new m
                                    ...
                                    onerror: function(e) {
                                        throw "Failed to fetch" === e.message && (e = new m("An error occurred. Either the engine you requested does not exist or there was another issue processing your request. If this issue persists please contact us through our help center at help.openai.com.")), n({
                                            err: e
                                        }), e
                                    }
                                }).catch(function(e) {
                        ...
                        return this.fetch("".concat(v, "/conversation/message_feedback"), {
                            method: "POST",
                            headers: (0, a.Z)({
                                "Content-Type": "application/json"
                            }, this.getAuthHeader()),
                        ...
                        return (0, r.Z)(function() {
                            return (0, c.__generator)(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return [4, t.fetch("".concat(v, "/check_data_captcha"), {
                                            method: "GET",
                                            headers: (0, a.Z)({
                                                "Content-Type": "application/json"
                                            }, t.getAuthHeader(e))
                        ...
                        return this.fetch("".concat(v, "/data_captcha/").concat(e.captchaId), {
                            method: "POST",
                            headers: (0, a.Z)({
                                "Content-Type": "application/json"
                            }, this.getAuthHeader(t)),
                        ...
                        return this.fetch("".concat(y.env.INTERNAL_API_URL, "/api/payments/checkout_session"), {
                            method: "POST",
                            headers: (0, a.Z)({
                                "Content-Type": "application/json"
                            }, this.getAuthHeader(t)),
